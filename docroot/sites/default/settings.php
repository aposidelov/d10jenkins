 ...
 * @endcode
 */
$settings['hash_salt'] = 'wYZzV0KuvYiVXKcGX5_i6oQ5eTM6-sgDtIdr5UIwjYXWhM1iSRYXte9sPqAWi92JZpMDj2is4w';
...
$settings['config_sync_directory'] = 'sites/default/files/config_lvmOxVAPGAqpL5KMuibuJ7Sy-5Q9zdd_zlsVwPjuTFis50CLL5kinJZENx-pPPjND14g9Mzvkw/sync';

// Connect to the SOLR host.
if (!empty(getenv('DRUPAL_SOLR_HOST'))) {
  $config['search_api.server.rpx_drupal_solr_server']['backend_config']['connector_config']['host'] = getenv('DRUPAL_SOLR_HOST');
  $config['search_api.server.rpx_drupal_solr_server']['backend_config']['connector_config']['solr_install_dir'] = getenv('DRUPAL_SOLR_DIR') ?: '../../..';
}
